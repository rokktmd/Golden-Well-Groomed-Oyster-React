        ...
        <div data-thq="thq-navbar-nav" className="navbar8-desktop-menu">
          <nav className="navbar8-links1">
            ...
            >
              {props.link3 ?? (
                <Fragment>
                  <span className="navbar8-text18">#broadcast-graphics</span>
                </Fragment>
              )}
            </a>
            <div
          ...
          <div className="navbar8-buttons1">
            <button className="navbar8-action11 thq-button-animated thq-button-filled">
              <span>
                {props.action1 ?? (
                  <Fragment>
                    <span className="navbar8-text14">Get Started</span>
                  </Fragment>
                )}
              </span>
            </button>
                            ...
                            {props.page1Description ?? (
                              <Fragment>
                                <span className="navbar8-text24">
                                  Explore our software development and IT
                                  services.
                                </span>
                              </Fragment>
                            )}
                            ...
                            {props.page2Description ?? (
                              <Fragment>
                                <span className="navbar8-text16">
                                  Discover our range of IT services and
                                  solutions.
                                </span>
                              </Fragment>
                            )}
                            ...
                            {props.page3Description ?? (
                              <Fragment>
                                <span className="navbar8-text17">
                                  Learn about our broadcast graphics services.
                                </span>
                              </Fragment>
                            )}
                          </span>
                            ...
                            {props.page4Description ?? (
                              <Fragment>
                                <span className="navbar8-text23">
                                  Get in touch with us for your integration
                                  needs.
                                </span>
                              </Fragment>
                            )}
                  ...
                  <div className="navbar8-content5">
                    ...
                    <span className="thq-body-small">
                      {props.page1Description ?? (
                        <Fragment>
                          <span className="navbar8-text24">
                            Explore our software development and IT services.
                          </span>
                        </Fragment>
                      )}
                    </span>
                  ...
                  <div className="navbar8-content6">
                    ...
                    <span className="thq-body-small">
                      {props.page2Description ?? (
                        <Fragment>
                          <span className="navbar8-text16">
                            Discover our range of IT services and solutions.
                          </span>
                        </Fragment>
                      )}
                    </span>
                  ...
                  <div className="navbar8-content8">
                    ...
                    <span className="thq-body-small">
                      {props.page4Description ?? (
                        <Fragment>
                          <span className="navbar8-text23">
                            Get in touch with us for your integration needs.
                          </span>
                        </Fragment>
                      )}
                    </span>
...
Navbar8.defaultProps = {
  ...
  page3ImageSrc:
    'https://images.unsplash.com/photo-1646660100990-a0e414c60cae?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc1NjkyMDAzOHw&ixlib=rb-4.1.0&q=80&w=1080',
  ...
  page2ImageSrc:
    'https://images.unsplash.com/photo-1713978504175-f7f4b0aefc3b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc1NjkyMDAzOHw&ixlib=rb-4.1.0&q=80&w=1080',
  page1Description: undefined,
  action2: undefined,
  page3ImageAlt: 'Broadcast Graphics Image',
  linkUrlPage4: 'https://www.teleporthq.io',
  page4ImageSrc:
    'https://images.unsplash.com/photo-1522071820081-009f0129c71c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc1NjkyMDAzN3w&ixlib=rb-4.1.0&q=80&w=1080',
  page2: undefined,
  ...
  page1ImageSrc:
    'https://images.unsplash.com/photo-1586862040767-36ea497fa682?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc1NjkyMDAzN3w&ixlib=rb-4.1.0&q=80&w=1080',
  logoAlt: 'KTMD Logo',
  link2: undefined,
