              ...
              <div className="pricing14-price10">
                <div className="pricing14-price11">
                  <p className="pricing14-text107 thq-body-large">
                    {props.plan1 ?? (
                      <Fragment>
                        <span className="pricing14-text200">Basic Plan</span>
                      </Fragment>
                    )}
                  </p>
                  <h3 className="pricing14-text108 thq-heading-3">
                    {props.plan1Price ?? (
                      <Fragment>
                        <span className="pricing14-text161">$99/month</span>
                      </Fragment>
                    )}
                  </h3>
                  <p className="thq-body-large">
                    {props.plan1Yearly ?? (
                      <Fragment>
                        <span className="pricing14-text172">$999/year</span>
                      </Fragment>
                    )}
                  </p>
                </div>
            ...
            <div className="pricing14-column2 thq-card">
              <div className="pricing14-price12">
                <div className="pricing14-price13">
                  ...
                  <h3 className="pricing14-text115 thq-heading-3">
                    {props.plan2Price ?? (
                      <Fragment>
                        <span className="pricing14-text181">$199/month</span>
                      </Fragment>
                    )}
                  </h3>
                  <p className="thq-body-large">
                    {props.plan2Yearly ?? (
                      <Fragment>
                        <span className="pricing14-text180">$1999/year</span>
                      </Fragment>
                    )}
                  </p>
                </div>
                      ...
                      {props.plan2Feature4 ?? (
                        <Fragment>
                          <span className="pricing14-text192">
                            Full Broadcast Equipment Integration
                          </span>
                        </Fragment>
                      )}
                    </span>
              ...
              <button className="pricing14-button15 thq-button-animated thq-button-filled">
                <span className="thq-body-small">
                  {props.plan2Action ?? (
                    <Fragment>
                      <span className="pricing14-text155">Sign Up Now</span>
                    </Fragment>
                  )}
                </span>
              </button>
              ...
              <div className="pricing14-price14">
                <div className="pricing14-price15">
                  ...
                  <h3 className="pricing14-text123 thq-heading-3">
                    {props.plan3Price ?? (
                      <Fragment>
                        <span className="pricing14-text203">$299/month</span>
                      </Fragment>
                    )}
                  </h3>
                  <p className="thq-body-large">
                    {props.plan3Yearly ?? (
                      <Fragment>
                        <span className="pricing14-text183">$2999/year</span>
                      </Fragment>
                    )}
                  </p>
                </div>
                      ...
                      {props.plan3Feature2 ?? (
                        <Fragment>
                          <span className="pricing14-text167">
                            Advanced IT Services Support with SLA
                          </span>
                        </Fragment>
                      )}
                    </span>
                      ...
                      {props.plan3Feature3 ?? (
                        <Fragment>
                          <span className="pricing14-text189">
                            High-End Broadcast Graphics Design
                          </span>
                        </Fragment>
                      )}
                    </span>
                      ...
                      {props.plan3Feature4 ?? (
                        <Fragment>
                          <span className="pricing14-text197">
                            Complete Broadcast Equipment Integration Services
                          </span>
                        </Fragment>
                      )}
                    </span>
            ...
            <div className="pricing14-column4 thq-card">
                      ...
                      {props.plan1Feature31 ?? (
                        <Fragment>
                          <span className="pricing14-text202">
                            Limited Broadcast Equipment Integration
                          </span>
                        </Fragment>
                      )}
                    </span>
              ...
              <button className="pricing14-button17 thq-button-animated thq-button-outline">
                <span className="thq-body-small">
                  {props.plan1Action1 ?? (
                    <Fragment>
                      <span className="pricing14-text204">Get started</span>
                    </Fragment>
                  )}
                </span>
              </button>
              ...
              <div className="pricing14-price18">
                <div className="pricing14-price19">
                  ...
                  <h3 className="pricing14-text139 thq-heading-3">
                    {props.plan2Price1 ?? (
                      <Fragment>
                        <span className="pricing14-text185">$299/yr</span>
                      </Fragment>
                    )}
                  </h3>
                  <span className="thq-body-large">
              ...
              <div className="pricing14-price20">
                <div className="pricing14-price21">
                  ...
                  <h3 className="pricing14-text147 thq-heading-3">
                    {props.plan3Price1 ?? (
                      <Fragment>
                        <span className="pricing14-text184">$499/yr</span>
                      </Fragment>
                    )}
                  </h3>
                  <span className="thq-body-large">
                      ...
                      {props.plan3Feature11 ?? (
                        <Fragment>
                          <span className="pricing14-text166">
                            Personalized Account Manager &amp; Team
                          </span>
                        </Fragment>
                      )}
                    </span>
                      ...
                      {props.plan3Feature31 ?? (
                        <Fragment>
                          <span className="pricing14-text168">
                            + Custom Features Development &amp; Integration
                          </span>
                        </Fragment>
                      )}
                    </span>
