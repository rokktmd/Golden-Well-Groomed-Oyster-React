          ...
          <div className="steps2-container3">
            <div className="steps2-container4 thq-card">
              <h2 className="thq-heading-2">
                {props.step1Title ?? (
                  <Fragment>
                    <span className="steps2-text26">Consultation</span>
                  </Fragment>
                )}
              </h2>
                ...
                {props.step1Description ?? (
                  <Fragment>
                    <span className="steps2-text29">
                      Initial meeting to understand client needs and
                      requirements.
                    </span>
                  </Fragment>
                )}
            ...
            <div className="steps2-container5 thq-card">
              <h2 className="thq-heading-2">
                {props.step2Title ?? (
                  <Fragment>
                    <span className="steps2-text30">Planning</span>
                  </Fragment>
                )}
              </h2>
                ...
                {props.step2Description ?? (
                  <Fragment>
                    <span className="steps2-text28">
                      Creating a detailed project plan and timeline for
                      development.
                    </span>
                  </Fragment>
                )}
            ...
            <div className="steps2-container6 thq-card">
              <h2 className="thq-heading-2">
                {props.step3Title ?? (
                  <Fragment>
                    <span className="steps2-text27">Development</span>
                  </Fragment>
                )}
              </h2>
                ...
                {props.step3Description ?? (
                  <Fragment>
                    <span className="steps2-text25">
                      Building and coding the software or graphics according to
                      specifications.
                    </span>
                  </Fragment>
                )}
                ...
                {props.step4Description ?? (
                  <Fragment>
                    <span className="steps2-text32">
                      Integrating the software or graphics with existing systems
                      and thorough testing for quality assurance.
                    </span>
                  </Fragment>
                )}
              </span>
