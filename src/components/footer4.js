        ...
        <div className="footer4-content">
          ...
          <div className="footer4-links">
            ...
            >
              {props.link1 ?? (
                <Fragment>
                  <span className="footer4-text17">Software Development</span>
                </Fragment>
              )}
            </a>
            <a
            ...
            >
              {props.link2 ?? (
                <Fragment>
                  <span className="footer4-text18">IT Services</span>
                </Fragment>
              )}
            </a>
            <a
            ...
            >
              {props.link3 ?? (
                <Fragment>
                  <span className="footer4-text16">Broadcast Graphics</span>
                </Fragment>
              )}
            </a>
            <a
